'''
Embark on a mission to tidy up our cosmic storage! In this task, you're provided with code that creates three S3 buckets 
destined for different sectors of our interstellar operations. However, to streamline our data storage, we need to 
decommission one of the buckets. Your task is to identify and delete the interstellar-operations-archive bucket. This will 
help us optimize our galactic data management strategy and ensure efficient use of resources.
'''
