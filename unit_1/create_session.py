'''
In this task, you will gain familiarity with establishing an AWS session and creating S3 resources and clients. 
This understanding will help set the foundation for further AWS-related tasks.
