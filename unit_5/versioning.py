'''
Explore versioning in cloud storage without writing a single line of code. In this task, you'll observe how versions of a 
document are uploaded to an S3 bucket, with each version ID captured. Understand how AWS S3 versioning maintains every 
document update. Simply click the Run button to upload document versions and see how to retrieve the latest and a specific 
earlier version by its version ID. Witness version control in action with just a click!
'''
